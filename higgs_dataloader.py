...
class HiggsDatasetPyG(torch_geometric.data.Dataset):
    def __init__(self, csv_file, edge_index, split, norm=True, root=None, transform=None, pre_transform=None,
                 pre_filter=None):
...
if __name__ == '__main__':
    ...
    higgs_dataset_torch = HiggsDatasetTorch(csv_file=csv_file)
